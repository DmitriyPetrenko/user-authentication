...
class FormCorrection extends Component {
    ...
    render() {
        const { textarea } = this.state.fields;
        const { resultCorrection } = this.state;
        const { formIsValid, onClickHandler, onFocusHandler } = this.props;
                    ...
                    >
                        ...
                        <div className="form__body">
                            <div className="form__body-item text-left">
                                ...
                                />
                                {!textarea.isValid && (
                                    <span className="form__error error">{textarea.messageError}</span>
                                )}
                            </div>
                            <div className="form__body-item text-left">
                                {resultCorrection && <div className="form__result">{resultCorrection}</div>}
                            </div>
