...
class FormRegistration extends Component {
    ...
    onSubmit(event) {
        const { registration, history, onSubmitHandler } = this.props;
    ...
    render() {
        const { username, email, password, passwordConfirm } = this.state.fields;
        const { isFetching, formIsValid, onClickHandler, onFocusHandler } = this.props;
                    ...
                    >
                        ...
                        <div className="form__body">
                            <div className="form__body-item">
                                ...
                                />
                                {!username.isValid && (
                                    <span className="form__error error">{username.messageError}</span>
                                )}
                            </div>
                            <div className="form__body-item">
                            ...
                            <div className="form__body-item">
                                ...
                                {!passwordConfirm.isValid && (
                                    <span className="form__error error">{passwordConfirm.messageError}</span>
                                )}
                            </div>
                            <div className="form__body-item">
